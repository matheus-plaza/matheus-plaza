...
<div id="tech" align="left">
  <h3>My Tech Stack</h3>
  <p>
    <img src="https://skillicons.dev/icons?i=java,spring,rabbitmq,angular,c,docker,maven,hibernate,postgres,mysql,postman,linux,git,gitlab,kafka" alt="Ferramentas e Tecnologias"/>
 </p>
